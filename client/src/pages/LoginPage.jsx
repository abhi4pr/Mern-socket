          ...
          {currState == "Sign up" ? (
            <p className="text-sm text-gray-600">
              ...
              <span
                ...
                className="font-medium text-voilet-500 cursor-pointer"
              >
                Login Here
              </span>
            </p>
